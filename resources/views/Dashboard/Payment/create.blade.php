...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            // استجابة لتغيير اسم المريض
            $('select[name="patient_id"]').change(function() {
                var patientId = $(this).val();

                // إرسال طلب Ajax للحصول على المبلغ المتبقي
                $.ajax({
                    url: '/getRemainingAmount/' + patientId,
                    type: 'GET',
                    success: function(response) {
                        // تحديث حقل المبلغ بالقيمة المتبقية
                        $('input[name="credit"]').val(response.remainingAmount);
                    },
