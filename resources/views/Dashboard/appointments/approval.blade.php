   ...
   <div class="modal-dialog">
       <div class="modal-content">
           <div class="modal-header">
               <h5 class="modal-title" id="exampleModalLabel">  {{ __('laboratorie_employee.Confirmation_Patient_Appointment') }}</h5>
                       ...
                       <div class="card">
                           <div class="card-body">
                                   <div class="input-group col-md-12">
                                       ...
                                       </div><input class="form-control" name="appointment" id="datetimepicker" type="text" value="{{$appointment->appointment_patient}} {{$appointment->time_patient}}">
                                   </div>
