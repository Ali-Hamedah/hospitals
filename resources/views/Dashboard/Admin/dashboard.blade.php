...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="main-dashboard-header-right">
						...
						<div>
							<label class="tx-13">{{ __('Admin.Number_Single_service') }}</label>
							<h5>{{ App\Models\Service::count() }}</h5>
						</div>
						<div>
							<label class="tx-13">{{ __('Admin.Number_Group_service') }} </label>
				...
				<div class="row row-sm">
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{ __('Admin.Number_doctors') }} </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{ __('Admin.Number_patients') }} </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{ __('Admin.Number_sections') }} </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
