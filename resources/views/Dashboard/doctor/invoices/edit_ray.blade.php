<!-- Modal -->
<div class="modal fade" id="edit_ray{{ $patient_ray->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('ray.update',$patient_ray->id)}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="invoice_id" value="{{$patient_ray->id}}">
