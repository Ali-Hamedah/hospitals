...
@section('content')
    ...
    <div class="row row-sm">
        ...
        <td>
            ...
            <a class="modal-effect btn btn-sm "  href="{{route('invoices_ray_employee.show',$invoice->id)}}"><img src="{{ asset('Dashboard/img/rays/' . $invoice->image->filename) }}" style="max-width: 100px; max-height: 100px;"></a>
        </td>
