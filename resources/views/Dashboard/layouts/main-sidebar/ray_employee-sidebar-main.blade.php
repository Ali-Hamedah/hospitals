    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('invoices_ray_employee.index') }}">
                            {{ __('ray_employee.X-ray_Detectors') }}</a></li>
                    <li><a class="slide-item" href="{{ route('completed.invoices.ray') }}">   {{ __('Doctors.List_completed_statements') }}</a>
                    </li>
