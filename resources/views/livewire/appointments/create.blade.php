    ...
    <form wire:submit.prevent="store">
        <div class="row clearfix" style="color: black">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 form-group" >
                ...
                <select name="doctor" wire:model="doctor" class="form-select" id="exampleFormControlSelect1" style="color: black">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                ...
                <select class="form-select" name="section" wire:model="section" id="exampleFormControlSelect1" style="color: black">
